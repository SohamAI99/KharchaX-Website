...
export default function GroupPage() {
  ...
  const handleCopyInvite = () => {
    ...
    // Construct the absolute URL (works locally and in production)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex justify-between items-end">
            <h2 className="text-xl font-bold tracking-tight text-foreground">Group Expenses</h2>
            <span className="text-sm text-text-secondary font-medium uppercase tracking-wider">Total: <span className="text-foreground">₹{totalSpent.toLocaleString()}</span></span>
          </div>
          
          <Card className="p-0 overflow-hidden">
            <div className="flex flex-col">
              {expenses.length === 0 ? (
                 <div className="p-8 text-center text-text-secondary text-sm">No expenses added yet.</div>
              ) : (
        ...
        <div className="space-y-8">
          ...
          {/* Members list */}
          <div>
            <h2 className="text-xl font-bold tracking-tight mb-4 text-foreground">Members</h2>
            <Card className="p-4">
