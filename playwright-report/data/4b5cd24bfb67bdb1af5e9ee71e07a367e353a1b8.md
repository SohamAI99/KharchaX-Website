...
- Name: dashboard.spec.ts >> Navigation flow from Dashboard to Add Expense
- Location: tests\dashboard.spec.ts:22:5
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Add Expense' })
